...
(function (document, window) {
    ...
    function initDragMove(elment) {
        ...
        function divMove(e) {
            isDrag = true;
            //el.style.top = el.offsetTop + (mouseY - e.y) ;
            //el.style.left = el.offsetLeft+(mouseX - e.x) ;
            ...
            if (xDis > 0 || xDis < 0) {
                ...
                var leftStyle = (left - xDis) + 'px';
                el.style.left = leftStyle;
            }
            if (yDis > 0 || yDis < 0) {
               var topStyle = (top - yDis) + 'px';
